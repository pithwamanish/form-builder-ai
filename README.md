...
- **Multi-Tenant Credentials & Contexts (Part D Differentiator)**:
  ...
  - *Switch multi-tenant data boundaries directly using the **Tenant Switcher** dropdown in the top navbar to verify strict Eloquent ORM tenant isolation (`TenantScope` / `BelongsToTenant`).*
